...
class Sodoku{
    private:
        ...
        // no repeats in row
        // keep pick rand number until it fits into constraints
        // pick complements with value 10-number, insert it into random spots until it fit the number
        ...
        void generate() {
            ...
            //         columns[i][j] = false;
            //         boxes[i][j] = false;
            //         unSolved[i][j].value.value = j+1;
            //         unSolved[i][j].value.isRevealed = 1;
            //         solved[i][j].value.value = j+1;GridCordinates
            //         solved[i][j].value.isRevealed = 1;
            //     }
            // }
        }


        void AttemptToGenerate2() {
